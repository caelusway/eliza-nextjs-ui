...
export function CircleIndicator({ 
  ...
  return (
    <div className={`flex items-center justify-center ${sizes.container} rounded-full bg-gradient-to-br from-zinc-100 to-zinc-200 dark:from-zinc-800 dark:to-zinc-700`}>
      {isLoading ? (
        <div 
