      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Research Paper</h2>
              <p className="text-sm text-zinc-500 dark:text-zinc-400">Paper details and abstract</p>
            </div>
          </div>
          <button
        ...
        <div className="space-y-6 max-h-96 overflow-y-auto mb-6">
          ...
          {paper.doi && (
            <div className="space-y-2">
              ...
              <p className="text-sm font-mono text-zinc-700 dark:text-zinc-300 bg-zinc-50 dark:bg-zinc-800 rounded-lg px-3 py-2 break-all">
                {paper.doi}
              </p>
            </div>
          )}
        ...
        <div className="flex items-center justify-between pt-4 border-t border-zinc-200 dark:border-zinc-700">
          ...
          {canViewPaper ? (
            ...
            <button
              disabled
              className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-200 dark:bg-zinc-700 text-zinc-500 dark:text-zinc-400 text-sm font-medium rounded-lg cursor-not-allowed"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
